...
```
https://box-api-git-polymarket-decent-webapp.vercel.app
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/getAction?\
...
```bash
curl -X POST "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/createOrFetchPolymarketUser" \
...
```bash
curl -G "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/search?q=patriots&activeOnly=true" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -G "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/search?tagId=450&tagId=226" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getMarkets?clobTokenIds=tokenId1,tokenId2" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
````
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getMarkets?clobTokenIds=tokenId1&clobTokenIds=tokenId2" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getMarkets?slugs=slug1,slug2" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getPrice?clobTokenId=80746058984644290629624903019922696017323803605256698757445938534814122585786&side=BUY" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getTrendingMarkets?limit=20" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
[
  {
    "proxyWallet": "0xbedcad563ddf52391573a016bc5ec7a334eec756",
    "side": "BUY",
    "asset": "18508413483771104636176620729953693881676306054057455788312812026480197215143",
    "conditionId": "0x52f13a5eaf375170189f326e58cc6d217515de1cf9e41bff17be7779ea9a295c",
    "size": 8.510637,
    "price": 0.469999954174993,
    "timestamp": 1764622490,
    "title": "Spread: Patriots (-7.5)",
    "slug": "nfl-nyg-ne-2025-12-01-spread-home-7pt5",
    "icon": "https://polymarket-upload.s3.us-east-2.amazonaws.com/nfl.png",
    "eventSlug": "nfl-nyg-ne-2025-12-01",
    "outcome": "Patriots",
    "outcomeIndex": 0,
    "name": "",
    "pseudonym": "",
    ...
    "transactionHash": "0xf11929aad45190213ff3f40d60b3bc82365166cc10b9c8018431e5aa4c5d7408"
  }
]
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getTrades?userId=user_123" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getActivity?userId=user_123" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
[
  {
    ...
    "size": 18.510637,
    "avgPrice": 0.469999,
    "initialValue": 8.699980879363,
    "currentValue": 18.510637,
    "cashPnl": 9.810656120636999,
    "percentPnl": 112.76641014129815,
    "totalBought": 18.510637,
    "realizedPnl": 0,
    "percentRealizedPnl": 112.76641014129815,
    "curPrice": 1,
    "redeemable": true,
    "mergeable": false,
    "title": "Spread: Patriots (-7.5)",
    ...
    "outcome": "Patriots",
    "outcomeIndex": 0,
    "oppositeOutcome": "Giants",
    "oppositeAsset": "103821619123283449656302676569513585770347243680728931670315948714771505071634",
    "endDate": "2025-12-02",
    "negativeRisk": false
  }
]
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getCurrentPositions?userId=user_123" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getCurrentPositions?userId=user_123&redeemable=true" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getCurrentPositions?userId=user_123&mergable=true" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
[
  {
    "proxyWallet": "0xbedcad563ddf52391573a016bc5ec7a334eec756",
    "asset": "11064405100562260054394340255823522843589213069258780033999551011138768074831",
    "conditionId": "0x8595fd57b8c332261274d8365ec1901b3b8744d0a1c32688a2d3c0bd203ff1c5",
    "size": 5,
    "avgPrice": 0.52,
    "initialValue": 2.6,
    "currentValue": 3.275,
    "cashPnl": 0.675,
    "percentPnl": 25.961538461538463,
    "totalBought": 5,
    "realizedPnl": 0,
    "percentRealizedPnl": 25.961538461538463,
    "curPrice": 0.655,
    "redeemable": false,
    "mergeable": false,
    "title": "Will the Chicago Bears make the playoffs?",
    "slug": "will-the-chicago-bears-make-the-playoffs",
    "icon": "https://polymarket-upload.s3.us-east-2.amazonaws.com/will-they-make-the-nfl-playoffs-oNphuibDi9il.png",
    "eventId": "24058",
    "eventSlug": "which-nfl-teams-will-make-the-playoffs-167",
    "outcome": "Yes",
    "outcomeIndex": 0,
    "oppositeOutcome": "No",
    "oppositeAsset": "43102609900612064878523985144127283227498093125200167117034359836110418779705",
    "endDate": "2026-01-13",
    "negativeRisk": false
  }
]
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getClosedPositions?userId=user_123" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/getPnL?userId=user_123" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash
curl -X POST "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/polymarket/cancelOrder" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY" \
  -d '{
    "evmEoa": "0x1234567890123456789012345678901234567890",
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/getStatus?txId=0x30e7dc0566713417a7bc136ad3bb4f8525e005e2e024ef696b7b88f497e394e8" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
...
**Endpoint:** `GET /api/workflows/getTags`
...
```bash
curl -X GET "https://box-api-git-polymarket-decent-webapp.vercel.app/api/workflows/getTags" \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_API_KEY"
```
